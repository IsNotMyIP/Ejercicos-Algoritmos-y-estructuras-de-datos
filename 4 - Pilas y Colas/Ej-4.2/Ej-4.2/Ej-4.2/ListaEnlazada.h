...
public:
	...
	// Complejidad temporal: O(n^3). Para calcularlo, mira "Sumatorio" en Wikipedia y observa lo siguiente:
	// Sumatorio de i desde i=1 hasta i=n es n(n+1)/2
	// Sumatorio de i^2 desde i=1 hasta i=n es n^3/3 + n^2/2 + n/6
	// Sumatorio de una suma es la suma de los sumatorios de cada sumando (lo mismo para restas)
	// sumatorio de una constante por algo es la constante por el sumatorio de ese algo
	// Complejidad espacial: O(1)
	void ordenar();
