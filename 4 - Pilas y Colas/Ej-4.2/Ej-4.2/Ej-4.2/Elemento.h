...
// Clase que representa a los objetos que contiene una lista
// Internamente, Elemento tendrá un atributo privado que será el dato real
class Elemento
{
	string valor; // Valor del elemento. Dato que realmente guarda el elemento
public:
